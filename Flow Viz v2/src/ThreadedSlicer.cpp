...
void ThreadedSlicer::startSlicer(float _scaleFactor, vector<Slice> *_mainThreadSlices, int *_mainThreadSliceDirection, int _orientation){

    orientation = _orientation;
    mainThreadSlices = _mainThreadSlices;
    scaleFactor = _scaleFactor;
    mainThreadSliceDirection = _mainThreadSliceDirection;
...
void ThreadedSlicer::update(){
    ...
    if(reSlice.tryReceive(tempSlices)){
        ...
        //set main thread slicing orientation to the new orientation
        (*mainThreadSliceDirection) = orientation;
